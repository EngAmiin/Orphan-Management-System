            ...
            <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="col-md-6 ">
                  <input type="text" class="form-control" name="email" placeholder="Ina Hebel" required>
                                ...
                                <div class="col-md-12 ind_id">
                                    <select class="form-control in_id" id="wasteTypeSelect">

                                    </select>
                                </div>
                                <div class="col-md-12 waste-id">
                                    <select class="form-control w_id">
                                ...
                                <!-- <div class="form-group">
                                    <label for="options">What do you want to dispose:</label><br>
                                    <div class="col-md-12">
                                        <input class="form-check-input opt1" type="checkbox" id="option1"
                                            value="option1">
                                    ...
                                    <div class="col-md-12">
                                        <input class="form-check-input opt2" type="checkbox" id="option2"
                                            value="option2">
                                ...
                                <!-- <div class="col-md-12">
                                    <input type="number" class="form-control wast" hidden id="input1"
                                        placeholder="immisa loor?" name="input1">

                                </div> -->

                                <div class="col-md-12">
                                    <input type="number" class="form-control qty" placeholder="How much?">
                                </div>
                                ...
                                <div class="col-md-12 text-center">
                                    ...
                                    <button type="button" class="btn btn-danger request">Request</button>
                                </div>
