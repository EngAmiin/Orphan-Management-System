  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          <li><a href="./index.php#hero" class="active text-white " style="font-size:24px">Home</a></li>
          <li><a href="./child gallery.php" class="text-white " style="font-size:24px">Child Gallery</a></li>

          <li><a href="./Donate.php" class="text-white" style=" font-size:24px">Donate</a></li>
          <li><a href="./photo gallery.php" class="text-white " style="font-size:24px">Photo Gallery</a></li>
          <li><a href="./programs.php" class="text-white " style="font-size:24px">Programs</a></li>
          <li><a href="./feedback.php" class="text-white " style="font-size:24px">Feedback</a></li>
    ...
    <div class="ui grid">
      ...
      <div class="twelve wide column">
        ...
        <section id="hero" class="hero">
          ...
          <img src="../application/uploads/b1.jpg" alt="" data-aos="fade-in">
