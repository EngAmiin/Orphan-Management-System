	...
	<nav id="sidebar" class="sidebar js-sidebar">
		<div class="sidebar-content js-simplebar">
			...
			<ul class="sidebar-nav">
				...
				<li class="sidebar-item">
					<a class='sidebar-link' href='../view/children.php'>
						<i class="align-middle" data-feather="list"></i> <span class="align-middle">children</span>
						<!-- <span class="sidebar-badge badge bg-primary">Pro</span> -->
					</a>
				</li>

				<li class="sidebar-item">
					<a class='sidebar-link' href='../view/sponsers.php'>
						<i class="align-middle" data-feather="calendar"></i> <span class="align-middle">sponsers</span>
						<!-- <span class="sidebar-badge badge bg-primary">Pro</span> -->
					</a>
				</li>
				<li class="sidebar-item">
					<a class='sidebar-link' href='../view/donators.php'>
						<i class="align-middle" data-feather="calendar"></i> <span class="align-middle">donators</span>
						<!-- <span class="sidebar-badge badge bg-primary">Pro</span> -->
					</a>
				</li>
				<li class="sidebar-item">
					<a class='sidebar-link' href='../view/gift.php'>
						<i class="align-middle" data-feather="calendar"></i> <span class="align-middle">Gifts</span>
						<!-- <span class="sidebar-badge badge bg-primary">Pro</span> -->
					</a>
				</li>
				<li class="sidebar-item">
					<a class='sidebar-link' href='../view/program.php'>
						<i class="align-middle" data-feather="calendar"></i> <span class="align-middle">program</span>
						<!-- <span class="sidebar-badge badge bg-primary">Pro</span> -->
					</a>
				</li>
				<li class="sidebar-item">
					<a class='sidebar-link' href='../view/feedback.php'>
						<i class="align-middle" data-feather="calendar"></i> <span class="align-middle">feedback</span>
						<!-- <span class="sidebar-badge badge bg-primary">Pro</span> -->
					</a>
				</li>
				<!-- <li class="sidebar-item">
